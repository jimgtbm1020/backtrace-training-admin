-- Extend the active-user Attendee Directory RPC so read-only history consumers
-- can display complete certificate/person details without widening direct table RLS.
