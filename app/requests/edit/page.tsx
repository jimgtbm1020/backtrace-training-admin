...
export default function TrainingRequestEditPage(){
 ...
 return <main className="shell request-edit-page"><header className="header"><div><div className="brand help-heading">Edit Training Requests<HelpTip text="Update active requests, assign trainers, and confirm schedules here. Completed, closed, archived, cancelled, and finalized records remain locked."/></div><div className="subtitle">Role: {profile?.role||'Unassigned'} · completed records remain locked</div></div><a href="/">Back to dashboard</a></header>
